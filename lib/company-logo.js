// Resolves a company's brand mark for a ticker without needing an API key.
//
...
// image fails to load:
//
//   1. Parqet's public logo assets, keyed by ticker. Proper brand marks, and it
//      needs no domain, so it works for tickers we have no profile for.
//   2. The site's apple-touch-icon via DuckDuckGo, keyed by domain. Modern
//      brands ship a 180px version of their mark here.
//   3. Google's favicon service at 128px, keyed by domain. Lowest fidelity but
